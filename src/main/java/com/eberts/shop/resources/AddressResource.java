...
public class AddressResource {
	...
	@Operation(summary = "Find an Address by its CEP", tags = "Address with ViaCep API", responses = {
	...
	@Operation(summary = "Find CEPs for a Partial Address", tags = "Address with ViaCep API", responses = {
			@ApiResponse(description = "Success", responseCode = "200", content = {
